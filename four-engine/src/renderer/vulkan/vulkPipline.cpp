...
void VulkPipeline::Bind(VkCommandBuffer commandBuffer)
{
...
PipeLineConfigInfo VulkPipeline::DefaultPipeLineConfigInfo(const uint32_t width, const uint32_t height)
{
